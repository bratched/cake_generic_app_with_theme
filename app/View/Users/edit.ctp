...
<td>
    ...
    <table border="0" cellpadding="0" cellspacing="0"  id="id-form">
        <tr>
            ...
            <td > <?php  echo $this->Form->input('role_id',array( 'empty'=>'Choose One', 'label'=>'','style'=>'width:195px; padding:6px;')); ?>
            </td>
            <td></td>
        </tr>
        <tr>
        ...
        <div id="related-act-bottom">
            ...
            <div id="related-act-inner">
                ...
                <div class="right">
                    <h5>View </h5>
                    <ul class="greyarrow">
                        <li><a href="<?php  echo $this->Html->url(array('controller'=>'userGroups','action'=>'index'))?>">All User Groups</a></li>
                    </ul>
                    <ul class="greyarrow">
                        <li><a href="<?php  echo $this->Html->url(array('controller'=>'users','action'=>'index'))?>">All Users</a></li>
                    </ul>
                </div>
                <div class="clear"></div>
            </div>
