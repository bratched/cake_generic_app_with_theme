...
<head>
	...
	<?php
                ...
                echo $this->Html->script(array('jquery-1.10.1.min','../slider/coin-slider','jquery-ui-v1.10.3'));

				echo $this->Html->script(array('css_browser_selector','jquery.slimscroll.min'));
				echo $this->Html->css(array('../slider/coin-slider-styles'));
                echo $this->Html->script(array('custom-popup'));
                echo $this->Html->css(array('custom-popup'));
